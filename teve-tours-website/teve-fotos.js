...
window.TEVE_FOTOS = {
  ...
  /* ======================================================================
     4. TOURS  —  6 fotos
     ----------------------------------------------------------------------
     Son los 7 tours destacados, los únicos que llevan tarjeta. El resto
     del catálogo solo se cotiza desde el buscador y no necesita foto.
     TODAS: 800x500 px HORIZONTAL
     ====================================================================== */
  tours: {
    // "Xcaret Plus"
    // Ríos subterráneos, el espectáculo México Espectacular, la playa del parque.
    "xcaret-plus": "/img/tours/xcaret-plus.jpg",

    // "Xel-Há All Inclusive"
    // La caleta natural, gente haciendo snorkel, el salto del acantilado.
    "xelha": "/img/tours/xelha.jpg",

    // "Xplor (día)"
    // Tirolesa sobre la selva o los vehículos anfibios en el lodo.
    "xplor": "/img/tours/xplor.jpg",

    // "Xenotes"
    // Un cenote abierto con el rayo de luz entrando, o el kayak.
    "xenotes": "/img/tours/xenotes.jpg",

    // "Dolphin Royal Connection"
    // Delfín saltando con una persona, o el foot push.
    "dolphin-royal": "/img/tours/dolphin-royal.jpg",
